...
RETIRED_GRAPH_CHAINS = {"botanix", "polygon_zkevm", "mantle", "xlayer"}
...
def main() -> int:
    ...
    parser.add_argument("--chains", default=os.environ.get("SUPPLY_ACTIVITY_CHAINS", ",".join(DEFAULT_GRAPH_CHAINS)))

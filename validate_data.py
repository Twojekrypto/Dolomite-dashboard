...
RETIRED_TVL_CHAINS = {"Botanix", "Polygon zkEVM", "Mantle", "X Layer"}
EXPECTED_TVL_CHAINS = ALL_TVL_CHAINS - RETIRED_TVL_CHAINS
EXPECTED_ASSETS_LIVE_CHAIN_COUNT = 3
RETIRED_ASSETS_LIVE_CHAINS = {"botanix", "polygonzkevm", "mantle", "xlayer"}

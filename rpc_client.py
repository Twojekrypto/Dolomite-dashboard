...
CHAIN_ENV_KEYS = {
    ...
    "ethereum": ["ALCHEMY_ETHEREUM_RPC", "ALCHEMY_ETHEREUM_RPC_KAT", "ALCHEMY_ETHEREUM_RPC_DAN", "ALCHEMY_ETHEREUM_RPC_ZEN", "ALCHEMY_ETHEREUM_RPC_2", "ALCHEMY_ETHEREUM_RPC_3"],
    "arbitrum": ["ALCHEMY_ARBITRUM_RPC", "ALCHEMY_ARBITRUM_RPC_KAT", "ALCHEMY_ARBITRUM_RPC_DAN", "ALCHEMY_ARBITRUM_RPC_ZEN", "ALCHEMY_ARBITRUM_RPC_2", "ALCHEMY_ARBITRUM_RPC_3"],

...
class PortfolioPreviewContractsTest(unittest.TestCase):
    ...
    def test_vedolo_odolo_exercises_exclude_pairing_noise(self):
        ...
        self.assertIn('<colgroup><col style="width:148px"><col style="width:160px"><col style="width:116px"><col style="width:118px"><col style="width:96px"><col style="width:88px"></colgroup>', self.html)
        ...
        self.assertIn('const airdropRows = rows.filter(r => r.route === "airdrop");', self.html)
        ...
        self.assertIn("Airdrops", self.html)
        self.assertIn("airdrop claim", self.html)
        self.assertIn("Direct", self.html)
        self.assertIn("direct DOLO lock", self.html)

...
class FetchDolomiteRevenueTest(unittest.TestCase):
    ...
    def test_revenue_ui_surfaces_per_chain_audit_status(self):
        ...
        self.assertIn('"version": "revenue-20260708-all-time-revenue-hero"', route_html)
        self.assertLess(
        ...
        self.assertIn('data-veborrow-discount-mode="daily"', html)
        self.assertIn('data-veborrow-discount-mode="cumulative"', html)
        ...
        self.assertIn("veBorrowDiscountUsersMode", html)
        self.assertIn("setVeBorrowDiscountUsersMode", html)
        self.assertIn("discountUserCumulativeCount", html)

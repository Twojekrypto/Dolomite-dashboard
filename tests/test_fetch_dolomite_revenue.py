...
class FetchDolomiteRevenueTest(unittest.TestCase):
    ...
    def test_revenue_ui_surfaces_per_chain_audit_status(self):
        ...
        chain_header_index = html.index('data-veborrow-wallet-sort="chain"')
        address_header_index = html.index('data-veborrow-wallet-sort="address"')
        self.assertLess(chain_header_index, address_header_index)
        self.assertIn("veBorrowWalletSortKey", html)
        self.assertIn("sortVeBorrowWallets", html)
        self.assertIn("data-veborrow-wallet-sort=\"chain\"", html)
        ...
        self.assertIn("type-tag ${tagClass}", html)
        self.assertIn(".veborrow-wallet-table .type-tag.type-veborrow", html)
        self.assertIn(".veborrow-wallet-table .type-tag.type-borrower", html)
        ...
        self.assertIn('id="veBorrowWalletChainFilter"', html)
        self.assertIn('data-veborrow-wallet-chain="all"', html)
        self.assertIn('data-veborrow-wallet-chain="Ethereum"', html)
        self.assertIn('data-veborrow-wallet-chain="Arbitrum"', html)
        self.assertIn('data-veborrow-wallet-chain="Berachain"', html)
        self.assertIn("veBorrowWalletSearchQuery", html)
        self.assertIn("veBorrowWalletChainFilter", html)
        self.assertIn("filterVeBorrowWallets", html)
        self.assertIn("setVeBorrowWalletChainFilter", html)
        self.assertIn("clearVeBorrowWalletSearch", html)
        self.assertIn("veBorrowWalletSearchQuery = input.value", html)
        self.assertIn("rowChains.has(veBorrowWalletChainFilter)", html)
        self.assertIn('event.target.closest("#veBorrowWalletChainFilter")', html)

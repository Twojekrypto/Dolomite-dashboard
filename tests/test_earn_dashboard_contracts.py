...
"""
    ...
    def test_ethereum_canonical_workflow_rebuilds_verified_ledger_on_fresh_history(self):
        ...
        self.assertIn("--max-incremental-scan-workers 3", workflow)
    ...
    def test_earn_freshness_workflow_exposes_all_dedicated_arbitrum_and_ethereum_rpc_secrets(self):
        ...
        self.assertIn('_mainnet_rpc_from_env("XLAYER_RPC_QUICKNODE_TWOJE")', scanner)
        self.assertIn('"https://rpc.xlayer.tech/"', scanner)
        self.assertIn('"https://xlayerrpc.okx.com/"', scanner)
        import scan_earn_netflow
        self.assertEqual(scan_earn_netflow._endpoint_block_cap("https://rpc.xlayer.tech/"), 100)
        self.assertEqual(scan_earn_netflow._endpoint_block_cap("https://xlayerrpc.okx.com/"), 100)
        ...
        self.assertIn('_mainnet_rpc_from_env("ALCHEMY_XLAYER_RPC_ZEN")', scanner)
        self.assertIn('_mainnet_rpc_from_env("DRP_XLAYER_RPC_TWO")', scanner)

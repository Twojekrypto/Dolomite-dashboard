...
"""
    ...
    def test_history_overview_consolidates_duplicate_summary_metrics(self):
        ...
        self.assertIn("padding:13px 18px;background:linear-gradient", self.css)
        self.assertIn(".history-table td{padding:14px 18px", self.css)
        self.assertIn(".history-table col.col-date{width:13%}", self.css)
        self.assertIn(".history-table col.col-action{width:14%}", self.css)
        self.assertIn(".history-table col.col-assets{width:29%}", self.css)
        ...
        self.assertIn(".history-table tbody tr[data-row-key]:hover{background:linear-gradient", self.css)
        self.assertIn(".history-table tbody tr[data-row-key]:hover td{background:transparent}", self.css)
        self.assertNotIn(".history-table tbody tr:hover td{background:linear-gradient", self.css)
        self.assertIn("border-radius:0 4px 4px 0", self.css)
        ...
        self.assertIn('<span class="chain-short">${escapeHtml(chain.short)}</span>', self.source)
        self.assertNotIn("chain-name", self.source)
        self.assertIn(".chain-short{display:inline;font-family:var(--mono)}", self.css)
